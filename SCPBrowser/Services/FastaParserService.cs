    ...
    public class FastaParserService
    {
                    ...
                    try
                    {
                        ...
                        using (var insertCmd = connection.CreateCommand())
                        {
                            insertCmd.CommandText = @"
                                ...
                                (accession, entry_name, protein_name, gene_name, organism, full_header)
                                VALUES (@acc, @entry, @protein, @gene, @org, @header)
                            ";
        ...
        public async Task<ProteinAnnotation> GetAnnotationAsync(string accession)
        {
            ...
            using (var connection = new SqliteConnection(connectionString))
            {
                ...
                {
                    command.CommandText = @"
                        SELECT accession, entry_name, protein_name, gene_name, organism, full_header
